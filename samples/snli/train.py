...
from samples.snli.model import SNLIClassifier
from samples.snli.util import get_args, makedirs
  ...
  for batch_idx, batch in enumerate(train_iter):
    ...
    if iterations % args.dev_every == 0:
      ...
      print(dev_log_template.format(time.time() - start,
                                    ...
                                    100. * (1 + batch_idx) / len(train_iter), loss.item(), dev_loss.item(), train_acc,
                                    dev_acc))
      ...
      if dev_acc > best_dev_acc:
        ...
        snapshot_path = snapshot_prefix + '_devacc_{}_devloss_{}__iter_{}_model.pt'.format(dev_acc, dev_loss.item(),
                                                                                           iterations)
