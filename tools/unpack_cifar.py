...
# source directory
CIFAR10_DIR = '../../../data/CIFAR/cifar10'
CIFAR100_DIR = '../../../data/CIFAR/cifar100'

# extract cifar img in here.
CIFAR10_TRAIN_DIR = '../../../data/CIFAR/cifar10/train'
CIFAR10_VAL_DIR = '../../../data/CIFAR/cifar10/val'
CIFAR100_TRAIN_DIR = '../../../data/CIFAR/cifar100/train'
CIFAR100_VAL_DIR = '../../../data/CIFAR/cifar100/val'
...
def cifar10():
    ...
    for j in range(1, 6):
        ...
        for i in range(0, 10000):
            ...
            img_path = CIFAR10_TRAIN_DIR + '/' + str(train_data[b'labels'][i]) + '_' + str(i + (j - 1) * 10000) + '.jpg'
